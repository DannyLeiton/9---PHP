...
<?php
    ...
    $comentario = $_POST["comentario"];
	  ...
	  if($nombre == ""){
       $error .= "El nombre no puede estar vac&iacute;o<br>"; 
    }
    if($apellidoPaterno == ""){
       $error .= "El apellido Paterno no puede estar vac&iacute;o<br>";
    }
    if($mail == ""){
       $error .= "El mail no puede estar vac&iacute;o<br>"; 
    }
    if($comentario == ""){
       $error .= "El comentario no puede estar vac&iacute;o"; 
    }
  }
?>
</head>
